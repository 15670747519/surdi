...
class sycrop{
    ...
    public function text($text, $font, $size, $color = '#00000000', 
        ...
        //资源检测
        if(empty($this->img)){
        	$this->errmsg = '没有可以被写入文字的图像资源';
        	return false;
        }
        if(!is_file($font)){
        	$this->errmsg = "不存在的字体文件：{$font}";
        	return false;
        }
