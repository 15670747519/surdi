...
class db_mysql {
	...
	public function __construct($dbConfig)
	{
		...
		if(!$this->conn || !mysql_select_db($dbConfig['database'], $this->conn)){
			echo '<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />数据库无法链接，如果您是第一次使用，请先执行<a href="install">安装程序</a><br /><br /><a href="http://www.crystalcg.com" target="_blank">水晶石数字科技</a>';exit;
		}
