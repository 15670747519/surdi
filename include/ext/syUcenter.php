...
class syUcenter {
	...
	{
		$params = ( false != syExt("syUcenter") ) ? array_merge($this->params, syExt("syUcenter")) : $this->params;
		$params['UC_CLIENT_DIR'] = ("" != $params['UC_CLIENT_DIR']) ? $params['UC_CLIENT_DIR'] : DOYO_PATH."/ext/uc_client";
	...
	public function __call($func, $args)
	{
		...
		syError('无法找到该方法，请查阅本扩展及UCENTER的相关手册');
	}
}
?>
